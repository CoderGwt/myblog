...
from .screct_msg import _accountSid, _accountToken, _appId

# 开发者主账号中的ACCOUNT SID
_accountSid = _accountSid

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
# 开发者主账号中的AUTH TOKEN
_accountToken = _accountToken
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('18312663130', ['love', 5], "1")
        if result == 0:
            print('短信验证码发送成功！')
            break
