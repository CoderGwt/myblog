$(function () {
  ...
  $newsLi.click(function () {
    ...
    if (sClickTagId !== sCurrentTagId) {
            ...
            // 重置分页参数，不然会继续上一次的iPage和iTotalPage
            iPage = 1;
            iTotalPage = 1;
            fn_load_content()
        }
            ...
            if (index === 0){
              content = `
                <li style="display:block;"><a href="javascript:void(0);">
                 <img src="${one_banner.image_url}" alt="${one_banner.title}"></a></li>
              `;
              tab_content = `<li class="active"></li>`;
            } else {
              content = `
              <li><a href="javascript:void(0);"><img src="${one_banner.image_url}" alt="${one_banner.title}"></a></li>
              `;
              tab_content = `<li></li>`;
            }
